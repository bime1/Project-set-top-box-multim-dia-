...
public:
    ...
    shared_ptr <Photo> createPhoto(double latitude, double longitude, string path, string filename);
    shared_ptr <Video> createVideo(double duree, string path, string filename);
    shared_ptr <Film> createFilm(int tableau[], int nombreChapitres, string path, string filename);
